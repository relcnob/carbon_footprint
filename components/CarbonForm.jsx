...
function CarbonForm(props) {
  ...
  const formHandler = (e) => {
    ...
    fetch("/api/carbon-data/insert-data", {
      method: "POST",
  ...
  return (
    <>
      <form action="" method="POST" className={styles.carbonForm} onSubmit={formHandler}>
        <div>
          <h1>Choose social media platforms and adjust your time spent on them daily.</h1>
          <svg width="15" height="18" viewBox="0 0 15 18" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={handleFormArrow}>
            <path
